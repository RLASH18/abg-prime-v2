...
@section('content')
        ...
        <tr>
            <td style="text-align: center; padding-bottom: 32px;">
                <div
                    ...
                    <img src="https://cdn-icons-png.flaticon.com/512/646/646094.png" width="40" height="40"
                        alt="Email" style="vertical-align: middle; border: 0; opacity: 0.8;">
                </div>
            </td>
        </tr>
    </table>
    ...
    <p class="body-text"
        ...
        Thanks for joining <strong>{{ config('app.name') }}</strong>! To complete your registration and unlock all features,
        ...
        <tr>
            <td style="text-align: center;">
                ...
                <p style="margin: 0; font-family: monospace; font-size: 13px; color: #815331; word-break: break-all;">
                    <a href="{{ $url }}"
                        style="color: #815331; text-decoration: underline;">{{ $url }}</a>
                </p>
            </td>
        </tr>
    </table>
