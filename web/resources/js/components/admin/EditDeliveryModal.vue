        ...
        <DialogContent class="sm:max-w-lg">
            ...
            <div v-if="delivery">
                ...
                <div class="mb-4 rounded-lg border bg-muted/30 p-3">
                    ...
                    <div class="mt-1 text-sm" v-if="delivery.order?.user?.name">
                        <span class="font-medium text-muted-foreground"
                            >Customer:</span
                        >
                ...
                <div
                    ...
                    class="mb-4 rounded-lg border border-green-200 bg-green-50/50 p-3"
                >
                    <div class="text-sm">
                ...
                <Form
                    :action="deliveriesRoutes.updateStatus(delivery.id)"
                    method="patch"
                ...
                >
                    ...
                    <div class="space-y-2">
                        <Label for="scheduled_date"
                            >Scheduled Date<span class="text-red-500"
                                >*</span
                            ></Label
                        >
                        <Input
