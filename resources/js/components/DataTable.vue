...
<template>
    <div class="rounded-lg border border-border bg-card shadow-sm">
        <Table>
            ...
            <TableHeader>
                <TableRow
                    class="border-b border-border bg-muted/50 hover:bg-muted/50"
                >
                    <TableHead
            ...
            <TableBody>
                ...
                >
                    ...
                    >
                        <div
                            class="mb-5 rounded-full bg-gradient-to-br from-primary/10 to-primary/5 p-4"
                        >
                            <svg
                ...
                >
                    ...
                    >
                        <div
                            class="mb-4 h-8 w-8 animate-spin rounded-full border-b-2 border-primary"
                        ></div>
                        <p class="text-sm text-muted-foreground">
                            Loading data...
                        </p>
