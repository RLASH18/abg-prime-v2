...
<template>
    <BaseModal :open="open" title="Mark Item as Damaged" description="Record damaged inventory and reduce stock."
        @update:open="emit('update:open', $event)">
        <Form :action="damagedItemsRoutes.store()" v-slot="{ errors, processing }" @success="close" class="space-y-4">
